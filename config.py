...
MIN_ABSOLUTE_MANIM_DURATION_SECONDS = max(5.0, env_float("MIN_ABSOLUTE_MANIM_DURATION_SECONDS", 20.0))
MIN_VISUAL_TO_AUDIO_DURATION_RATIO = min(1.0, max(0.05, env_float("MIN_VISUAL_TO_AUDIO_DURATION_RATIO", 0.35)))
AV_SYNC_DURATION_REPAIR_ENABLED = env_bool("AV_SYNC_DURATION_REPAIR_ENABLED", False)
