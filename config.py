...
DATA_DIR = env_path("PARALLEA_DATA_DIR", BASE_DIR / "data", BASE_DIR)
...
for d in [DATA_DIR, UPLOADS_DIR, THUMBNAILS_DIR, AUDIO_DIR, SESSIONS_DIR, RENDERS_DIR, MANIM_RUNTIME_DIR, MANIM_DEBUG_DIR, PUBLIC_DIR, MANIM_PUBLIC_OUTPUT_DIR]:
